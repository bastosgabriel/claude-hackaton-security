"""Django settings for the claude-hackaton-security backend."""
...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="hackaton"),
        "USER": config("DB_USER", default="hackaton"),
        "PASSWORD": config("DB_PASS", default="hackaton"),
